    ...
    <div className="p-6 rounded-md shadow">
      ...
      <section>
        ...
        <p>
          ...
          directors or other managing authority. Country refers to: Ontario,
          Canada Company (referred to as either the Company, We, Us or Our in
          this Agreement) refers to COMPANY INC., COMPANY ADDRESS. Device means
          any device that can access the Service such as a computer, a cellphone
          or a digital tablet. Service refers to the Website. Terms and
          ...
          Service. Website refers to Pandem, accessible from http://pandem.dev/
      ...
      <p>
        ...
        USD if You havent purchased anything through the Service. To the maximum
        extent permitted by applicable law, in no event shall the Company or its
        ...
        of the above limitations may not apply. In these states, each partys
      ...
      <p>
        ...
        of the companys provider makes any representation or warranty of any
      ...
      <h2 className="text-2xl font-semibold mt-4 mb-2">Disputes Resolution</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">Waiver</h2>
      <p>
        Except as provided herein, the failure to exercise a right or to require
        performance of an obligation under these Terms shall not affect a partys
